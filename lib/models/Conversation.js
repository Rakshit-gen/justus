...
const ConversationSchema = new mongoose.Schema(
  {
    ...
    // Conversation-wide TTL in seconds. 0 = disappearing messages off.
    // When > 0, new messages get expiresAt = createdAt + this and are
    // auto-removed by Mongo's TTL index on Message.expiresAt.
    disappearingTtl: { type: Number, default: 0, min: 0 },
  },
  { timestamps: true }
);
